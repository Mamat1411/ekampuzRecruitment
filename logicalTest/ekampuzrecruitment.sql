...
--
ALTER TABLE `tb_mahasiswa_nilai`
  ADD CONSTRAINT `mhs_id` FOREIGN KEY (`mhs_id`) REFERENCES `tb_mahasiswa` (`mhs_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `mk_id` FOREIGN KEY (`mk_id`) REFERENCES `tb_matakuliah` (`mk_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
